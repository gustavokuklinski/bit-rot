...
def _draw_player_build_screen(game, state, mouse_pos):
    ...
    game.game_screen.blit(font_12.render(tr('ui', "Preset"), False, WHITE), (preset_header_rect.x + S(10), preset_header_rect.y + S(7)))

    game.game_screen.blit(font_12.render(tr('ui', "Player Name:"), False, WHITE), (preset_body_rect.x + padding, preset_body_rect.y + S(10)))
    ...
    save_text = font_12.render(tr('ui', "Save"), False, WHITE)
    ...
    random_text = font_12.render(tr('ui', "Random"), False, WHITE)
    ...
    delete_text = font_12.render(tr('ui', "Delete"), False, WHITE)
    ...
    game.game_screen.blit(font_12.render(tr('ui', "Sex:"), False, WHITE), (preset_body_rect.x + padding, sex_y))
    ...
    male_text = font_12.render(tr('ui', "Male"), False, WHITE)
    ...
    female_text = font_12.render(tr('ui', "Female"), False, WHITE)
    ...
    game.game_screen.blit(font_12.render(tr('ui', "Clothes"), False, WHITE), (gear_header_rect.x + S(10), gear_header_rect.y + S(7)))
    ...
    if drawable_gear_rect.width > 0 and drawable_gear_rect.height > 0:
        ...
        for slot_name in state['clothes_slots']:
            ...
            if cycle_rect_abs.bottom > gear_content_rect.top and cycle_rect_abs.top < gear_content_rect.bottom:
                gear_content_surface.blit(font_12.render(f"{tr('ui', slot_name.capitalize())}:", False, WHITE), (0, y_offset + S(5)))
    ...
    game.game_screen.blit(font_12.render(tr('ui', "Professions"), False, WHITE), (prof_header_rect.x + S(10), prof_header_rect.y + S(7)))
    ...
    if drawable_prof_rect.width > 0 and drawable_prof_rect.height > 0:
        ...
        for p_id in state.get('available_professions', []):
            ...
            if row_rect_rel.bottom > 0 and row_rect_rel.top < prof_content_rect.height:
                ...
                name_surf = font_12.render(tr('trait', base_name), False, WHITE)
                cost_surf = font_12.render(f"({trait_cost:+})", False, cost_color)
                ...
                prof_surface.blit(font_12.render(">", False, WHITE), (add_btn_rect_rel.x + S(7), add_btn_rect_rel.y + S(2)))
    ...
    game.game_screen.blit(font_12.render(tr('ui', "Traits"), False, WHITE), (avail_header_rect.x + S(10), avail_header_rect.y + S(7)))
    ...
    if content_surface:
        for i, trait_name in enumerate(state['available_traits']):
            ...
            if row_rect_rel.bottom > 0 and row_rect_rel.top < traits_content_rect.height:
                ...
                content_surface.blit(font_12.render(">", False, WHITE), (add_btn_rect_rel.x + S(7), add_btn_rect_rel.y + S(2)))
    ...
    game.game_screen.blit(font_12.render(tr('ui', ""), False, WHITE), (header_rect.x + S(10), header_rect.y + S(7)))
    ...
    cost_surf = font_12.render(cost_text, False, cost_color)
    ...
    if content_surface:
        for i, trait_name in enumerate(state['chosen_traits']):
            ...
            if row_rect_rel.bottom > 0 and row_rect_rel.top < chosen_content_rect.height:
                ...
                content_surface.blit(font_12.render("<", False, WHITE), (remove_btn_rect_rel.x + S(7), remove_btn_rect_rel.y + S(2)))
                
                display_name = TRAIT_DEFINITIONS.get(trait_name, {}).get('name', trait_name.capitalize())
                content_surface.blit(font_12.render(tr('trait', display_name), False, WHITE), (remove_btn_rect_rel.right + S(10), row_rect_rel.y))
    ...
    game.game_screen.blit(font_12.render(tr('ui', "Current Stats"), False, WHITE), (stats_header_rect.x + S(10), stats_header_rect.y + S(7)))
    ...
    if drawable_stats_rect.width > 0 and drawable_stats_rect.height > 0:
        ...
        for attr, value_obj in current_attrs.items():
            ...
            if xp_mod != 0:
                ...
                mod_surf = font_12.render(f"{int(xp_mod):+}% {tr('ui', 'XP')}", False, mod_color)
