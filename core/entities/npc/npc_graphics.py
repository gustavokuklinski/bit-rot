...
class NPCGraphics:
    ...
    def draw(self, surface, offset_x, offset_y, opacity=255):
        ...
        # --- NEW: Retrieve the wiggle generated by ZombieGraphics ---
        wiggle_y = getattr(self, '_current_wiggle_y', 0)
        ...
        if self.health < max_h and self.health_bar_timer > 0:
            ...
            # Add wiggle_y so the bar bounces with the NPC
            bar_y = self.rect.y + offset_y - 8 + wiggle_y 
