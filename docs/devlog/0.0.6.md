...
- [] Add: Create a "master menu button" like an Hamburger menu to open the others menus (Make UI cleaner)
- [] Add: Button to toggle all modals, always visible
- [] Add: Notification chip on the top right showing some: Player level up: [Skill] to [Skill level] and add the completed quests as it is.
- [] Add: Quests: Make some game achiavements like: 
