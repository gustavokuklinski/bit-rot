...
- [] Fix: [Fix] Removed the spawning on 'bg' tile (Rotters get stuck)
- [] Fix: [Fix] When paused keep the last modal position available
- [] Fix: [Fix] Place the pause at the top center contained in a box: PAUSED: Continue Save Exit
