...
On my settings.py and config.xml I want to be able to ajust the game volume with controls from 0 to 100. all by 25% carrousel. Start with:
Music volume: 50% (Music main volume)
Background volume: 50% (Atmospheric background sound)
Atmospheric volume: 50% (Sound of zombies, NPCs, Animals, items)
