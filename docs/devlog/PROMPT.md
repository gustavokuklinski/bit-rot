...
I want to change the map generator to a chunk generator. This chunk generator will turn each map chunk in to separated CSV files.
The map must have a teleport system to another chunk instead stitched map.
