...
- [] Fix: Create helpers scripts to: Pattern the game Button, Pattern the game scroolbars box
- [] Fix: Add a Back button to Player Creator
- [] Fix: Add a Menu button on Pause game
