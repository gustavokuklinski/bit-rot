...
- [] Fix: Animals have a delay to die
- [] Fix: Animals health bar disapeared

- [] Fix: Loot tables are generating item turned 'on'


- [] Fix: Check each maptile_container and assign specific loot to it
- [] Fix: Reduced tiles
