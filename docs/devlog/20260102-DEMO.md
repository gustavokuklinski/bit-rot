...
- [] Add: Weapon aim size depends on fire distance
...
- [] REF: Refactor entities/npc/npc.py for smaller files
- [] REF: Refactor entities/zombies/zombies.py for smaller files
