...
- [] Add: Allow the map editor to place items
- [] Add: If the player change the map, when save, store the new map changes

- [] Add: On ```recipes.xml``` add multiple item disassemble

- [TEST] Fix: Do not destroy items with ZERO durability

- [] Add: Tooltips for the player status
- [] Add: The player action speed for tasks depends on speed level
