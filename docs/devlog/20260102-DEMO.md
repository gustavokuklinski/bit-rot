...
- [] Add: New inteligence skill gained with crafting.
...
- [x] Add: The player action speed for tasks depends on speed level
- [] Fix: When the player Drag an item from Nearby and drop on Nearby the item disapear
