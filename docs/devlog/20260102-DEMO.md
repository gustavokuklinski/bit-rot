...
- [] Fix: When player place something from Inventory modal to Gear modal disable the loader display. The loader modal must be trigged only when transfer from Nearby modal (tabs and containers) to Inventory and/or Gear.
