...
- [] Add: On Vehicle use a new tag: <seats value="4"> as the number of available seats. Wrap it as a second column labeled as Seats with 2 columns and 2 rows on Vehicle Options modal context menu. The First seat is always the driver (Player is allowed to place items on seats if empty).
...
- [] Add: Item: Double Barrel Shot gun
