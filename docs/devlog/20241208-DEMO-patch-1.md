...
- [] Fix: Items on ground that are not backpack, containers or clothes displaying the option open
- [] Add: Make 5 points to be spread when start the game
- [] Fix: Show a negative points when start the character build
- [] Add: Create a button to reset the config to default config using xml file
