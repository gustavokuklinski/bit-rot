...
- [] Add: New mobile utility with charger (clock, minimap)
- [] Fix: Drop from right-click not working
- [] Fix: Nearby is duplicating loot
...
- [] Fix: Add sex to player ID and make random IDs for zombies
