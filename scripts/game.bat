...
set "VENV_DIR=.venv"
set "APP_SCRIPT=bitrot\bitrot.py"
set "REQUIREMENTS_FILE=requirements.txt"

:: Parse help & venv options natively
set "VENV_ONLY=false"
...
:show_help
echo Usage: game.bat [OPTIONS] [--] [APP_ARGS...]
echo.
echo Options:
...
echo   Any additional arguments will be passed to the game.
echo.
echo This script ensures a Python virtual environment is available and then runs the game.
exit /b 0