#!/bin/bash
# editor.sh – Run the Bit Rot editor
...
Options:
  ...
  Any additional arguments after -- will be passed to the editor.

This script ensures a Python virtual environment is available and then runs the editor.
EOF
}
